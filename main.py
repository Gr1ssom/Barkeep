...
from metrc_api import MetrcAPI  # Import the METRC API wrapper
...
class MetrcApp(QMainWindow):
    def __init__(self):
        ...
        self.metrc_api = MetrcAPI()  # Initialize API wrapper
        self.initUI()
    ...
    def initUI(self):
        ...
        self.results_table.setColumnCount(4)  # Adjust column count as needed
    ...
    def search_packages(self):
        ...
        try:
            ...
            filtered_packages = [
                pkg for pkg in packages if partial_tag.lower() in pkg['Label'].lower()
            ]
